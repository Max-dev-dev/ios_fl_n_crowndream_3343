...
class FavoriteAudiosScreen extends StatelessWidget {
  FavoriteAudiosScreen({super.key});

  final List<AudioModel> _allAudios = [
    AudioModel(
  ...
  Widget build(BuildContext context) {
    final favoriteTitles = context.watch<FavoriteAudioCubit>().state;

    final favoriteAudios =
        _allAudios
            .where((audio) => favoriteTitles.contains(audio.title))
            .toList();
